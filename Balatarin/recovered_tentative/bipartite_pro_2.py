...
l = open(PATH+"processed_data/threshold_max175-links_politics.txt","r")              # links_politics.txt
v = open(PATH+"raw_data/threshold_Umin20_Umax30000_Lmax175-votes.txt","r")  # votes-summary.txt
#h = open(PATH+"bipartite/"+dirName+"/"+bgraphname+".txt","w")
links = []
for line in l:
