...
graph_stats<-read.table("U-pol_J100VT5_stats.txt",header=FALSE)
...
plot(clustering_stats_ordered$ndates2,clustering_stats_ordered$V3,main="Modularity of detected communities over sliding window",xlab="Window
 start date",ylab="Modularity","l")
dev.off()
pdf("numComsVsTime.pdf")
plot(clustering_stats_ordered$ndates2,clustering_stats_ordered$V2,main="Number of communities over sliding window",xlab="Window start date",
ylab="Number of communities in graph","l")
dev.off()
...
pdf("RandvsTime.pdf")
plot(Randindex$ndates,Randindex$V2,main="Adjusted Rand index between consecutive clusterings",xlab="Window start date",ylab="Adjusted Rand i
ndex","l")
dev.off()
